...
[![R-CMD-check](https://github.com/Plant-Functional-Trait-Course/fluxible/actions/workflows/R-CMD-check/badge.svg)](https://github.com/Plant-Functional-Trait-Course/fluxible/actions/workflows/R-CMD-check.yaml)
[![CRAN
...
Gaudard, J., Trepel, J., Dawson, H. R., Enquist, B., Halbritter, A. H.,
Mustri, M., Niittynen, P., Santos-Andrade, P. E., Topper, J. P.,
Vandvik, V., and Telford, R. J.: Fluxible: an R package to calculate
