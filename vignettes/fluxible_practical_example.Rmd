...
```{r plot_exp_qua, fig.width = 8, fig.height = 9}
...
# fluxes_liahovden_60 |>
  dplyr::bind_rows(fluxes_exp_liahovden_60, fluxes_qua_liahovden_60) |>
  dplyr::filter(type == "NEE") |>
  ggplot2::ggplot(ggplot2::aes(x = f_start, y = flux, color = model)) +
  ggplot2::geom_point() +
  ggplot2::geom_smooth() +
  ggplot2::labs(
