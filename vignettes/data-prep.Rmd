...
For users of Li-COR instruments, the [licoread R package](https://joXXXX.github.io/licoread/index.html), developped in collaboration with Li-COR, is designed to read 82z and 81x files and import them as fluxible-friendly objets.
<!-- For users of LI-COR instruments, we present at the end of this section the Licoread R package [@XXXXLicoreadReadsRaw2025], to read specific LI-COR formats (82z and 81x). -->
