...
Plotting:
```{r plotting_co2, message=FALSE, warning=FALSE, fig.cap="Output of `flux_plot` for co2 fluxes"}
...
Plotting:
```{r plotting_h2o, message=FALSE, warning=FALSE, fig.cap="Output of `flux_plot` for h2o fluxes"}
