...
```{r figure_co2, echo=FALSE, fig.cap="Comparison of CO2 fluxes calculated with fluxible and published in Halbritter et al (2024).", message=FALSE, warning=FALSE, fig.width=8, fig.height=9}
...
```{r figure_h2o, echo=FALSE, fig.cap="Comparison of H2O fluxes calculated with fluxible and published in Halbritter et al (2024).", message=FALSE, warning=FALSE, fig.width=8, fig.height=9}
