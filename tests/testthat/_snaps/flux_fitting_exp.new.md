...
# fitting works with 30 second end cut
    ...
    Output
      ...
      #   f_n_conc <int>, Cm_est <dbl>, a_est <dbl>, b_est <dbl>, tz_est <dbl>,
      #   f_Cz <dbl>, time_diff <dbl>, f_Cm <dbl>, f_a <dbl>, f_b <dbl>, f_tz <dbl>,
...
# renaming works
    ...
    Output
      ...
      10 2022-07-28 23:43:44    NA         NA    453. NA    156 AN2C 156 ER   
      # i 1,241 more rows
      # i 23 more variables: f_start <dttm>, finish <dttm>, f_fluxID <fct>,
      #   n_conc <dbl>, ratio <dbl>, flag <chr>, f_time <dbl>, f_cut <fct>,
      #   f_n_conc <int>, Cm_est <dbl>, a_est <dbl>, b_est <dbl>, tz_est <dbl>,
      #   f_Cz <dbl>, time_diff <dbl>, f_Cm <dbl>, f_a <dbl>, f_b <dbl>, f_tz <dbl>,
      #   f_slope <dbl>, f_fit <dbl>, f_fit_slope <dbl>, f_start_z <dttm>
