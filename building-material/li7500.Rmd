...
pftc5_fits_lm_h2o <- flux_fitting(pftc5_match,
                                  f_conc = `H2O mmol/mol_dry`,
                                  fit_type = "linear",
                                  start_cut = 0,
                                  end_cut = 0)
...
```{r figure_co2, echo=FALSE, fig.cap="Comparison of fluxes calculated with fluxible and published in Halbritter et al (2024).", message=FALSE, warning=FALSE, fig.width=15, fig.height=18}
...
pftc5_published_fluxes_h2o <- read_csv(
  "vignettes/ex_data/li7500/PFTC3_Puna_PFTC5_Peru_2018_2020_wflux.csv",
  show_col_types = FALSE # quiet!
)
...
```{r figure_h2o, echo=FALSE, fig.cap="Comparison of fluxes calculated with fluxible and published in Halbritter et al (2024).", message=FALSE, warning=FALSE, fig.width=15, fig.height=18}
