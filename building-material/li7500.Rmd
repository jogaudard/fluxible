...
pftc5_fits <- flux_fitting(pftc5_match,
                           f_conc = `CO2 umol/mol`,
                           fit_type = "exp_zhao18",
                           start_cut = 0,
                           end_cut = 0)
...
```{r figure, include=FALSE, fig.cap="Comparison of fluxes calculated with fluxible and published in Halbritter et al (2024).", message=FALSE, warning=FALSE, fig.width=15, fig.height=12}
