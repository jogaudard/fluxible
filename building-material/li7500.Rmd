...
```{r figure_co2, echo=FALSE, fig.cap="Comparison of CO~2~ fluxes calculated with fluxible and published in Halbritter et al (2024).", message=FALSE, warning=FALSE, fig.width=15, fig.height=18}
...
```{r figure_h2o, echo=FALSE, fig.cap="Comparison of H~2~O fluxes calculated with fluxible and published in Halbritter et al (2024).", message=FALSE, warning=FALSE, fig.width=15, fig.height=18}
...
pftc5_fluxes_comparison_h2o |>
  ...
  facet_grid(f_model ~ flux, scales = "free") +
  labs(
    title = "Reprocessing of PFTC5 H~2~O flux data",
    x = "Fluxes calculated with Fluxible (exp_zhao18 and linear model respectively)",
    y = "Fluxes as published in the data paper",
    color = "Model (PFTC5)"
  ) 
