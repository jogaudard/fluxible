...
Thanks to its flexibility, it works for all kinds of setups (separated files for each measurement vs continuous logging, variable vs constant chamber volume, variable vs constant measurement length, ...).
It is organized as a toolbox with one function per steps, which offers a lot of freedom.
