...
#'
#' Slopes of linear fit for each flux with a 60 seconds cut at the end of each
#' flux.
#'
...
#' \item{PAR}{Photosyntethically active radiation inside the chamber in
#' micromol/s/sqm.}
...
#' \item{cut}{Indicating if the measurement should be kept (keep) or
#' discarded (cut).}
#' \item{p.value}{P-value of the linear model of CO2 concentration over time.}
#' \item{r.squared}{R squared of the linear model of CO2 concentration over
#' time.}
#' \item{adj.r.squared}{Adjusted R squared of the linear model of CO2
#' concentration over time.}
#' \item{intercept}{Intercept of the linear model of CO2 concentration over
#' time.}
