...
#' flux_plot_lin(slopes0lin_flag, datetime_col = "datetime", conc_col = "conc", cut_col = "cut", fit_col = "fit", start_col = "start", print_plot = TRUE)
#' @export
#' 
#' 
...
flux_plot_lin <- function(slopes_df,
  ...
  f_plotname <- paste(f_plotname, ".pdf")
...
if(((print_plot)) == TRUE) {print(plot_lin)}
