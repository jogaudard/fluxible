...
#' \item{f_pvalue}{P-value of the quadratic model of gas concentration over time.}
#' \item{f_rsquared}{R squared of the quadratic model of gas concentration over time.}
#' \item{f_adj_rsquared}{Adjusted R squared of the quadratic model of gas concentration over time.}
#' \item{f_intercept}{Intercept of the quadratic model of gas concentration over time.}
