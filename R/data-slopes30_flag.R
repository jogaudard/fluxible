...
#' \item{f_cut}{Indicating if the measurement should be kept (keep) or discarded (cut).}
...
#' \item{Cm}{Cm parameter of the C(t) function, calculated by optim() with Cm_est as starting point.}
#' \item{a}{a parameter of the C(t) function, calculated by optim() with a_est as starting point.}
#' \item{f_b}{b parameter of the C(t) function, calculated by optim() with b_est as starting point.}
#' \item{tz}{tz parameter of the C(t) function, calculated by optim() with tz_est as starting point.}
...
#' \item{f_cor_coef}{coefficient of correlation between gas concentration and time}
...
#' \item{f_correlation}{flagging if there is a correlation between gas concentrationa and time}
