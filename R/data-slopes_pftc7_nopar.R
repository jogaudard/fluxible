...
#' without PAR (for testing purposes)
#' 
#' @format a tibble with 24 columns and 1665 rows
#' \describe{
...
#' \item{f_rsquared}{R² of model.}
#' \item{f_adj_rsquared}{Adjusted R² of model.}
#' \item{f_pvalue}{p-value of model.}
...
#' \item{f_segment_length}{Length of each segment.}
#' }
#' @examples
#' slopes_pftc7_nopar
"slopes_pftc7_nopar"
