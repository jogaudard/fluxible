...
adj_cran_downloads(c("fluxible", "licoread"), "last-month") |>
...
adj_cran_downloads(c("fluxible", "licoread"), from = "2025-09-24", to = date_end) |>
  mutate(
...
adj_cran_downloads(c("fluxible", "licoread"), from = "2024-08-27", to = date_end) |>
  mutate(
